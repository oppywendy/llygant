...
import pic10 from "../assets/seventeen-removebg-preview.png";
import pic11 from "../assets/eighteen-removebg-preview.png";
import pic12 from "../assets/ninteen-removebg-preview.png";
import pic13 from "../assets/twenty-removebg-preview.png";
import pic14 from "../assets/twenty-one-removebg-preview.png";
import pic15 from "../assets/twenty-two-removebg-preview.png";
const Hero = () => {
  return (
      ...
      <div className="w-[96%] h-[100%] justify-center items-center grid md:grid-cols-3 grid-cols-2 md:gap-5 gap-2 mt-10">
        ...
        <div className="md:w-[350px] w-[180px] cursor-pointer">
          <img
            ...
            alt=""
          />
          <h1 className="pt-3 md:text-lg text-sm">LLYGANT T-SHIRT (BLACK)</h1>
          <p className="pt-2 md:text-lg text-sm">$500.00 USD</p>
        </div>
